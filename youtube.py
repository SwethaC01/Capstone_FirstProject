...
if selected =='VIEW':
        ...
        if Question=='1.What are the names of all the videos and their corresponding channels?':
                ...
                df=pd.DataFrame(q1,columns=["ChannelName","VideoName"])
                st.write(df)
                ...
                df2=pd.DataFrame(q2,columns=["ChannelName","VideoCount"])
                st.write(df2)
                ...
                df3=pd.DataFrame(q3,columns=["ChannelName","VideoViewCount"])
                st.write(df3)
                ...
                df5=pd.DataFrame(q5,columns=["ChannelName","VideoLikeCount"])
                st.write(df5)
